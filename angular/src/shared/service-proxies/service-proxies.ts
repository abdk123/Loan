...
export class CustomerServiceProxy {
     ...
     * @return Success
     */
    getAllForGrid(): Observable<ReadCustomerDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Customer/GetAllForGrid";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ReadCustomerDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<ReadCustomerDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllForGrid(response: HttpResponseBase): Observable<ReadCustomerDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(ReadCustomerDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<ReadCustomerDto[]>(<any>null);
    }
...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getAllForGrid(): Observable<ReadEmployeeDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetAllForGrid";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllForGrid(response: HttpResponseBase): Observable<ReadEmployeeDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getById(id: number | undefined): Observable<EmployeeDto> {
    ...
    protected processGetById(response: HttpResponseBase): Observable<EmployeeDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class NationalityServiceProxy {
     ...
     */
    create(body: CreateIndexDto | undefined): Observable<IndexDto> {
        let url_ = this.baseUrl + "/api/services/app/Nationality/Create";
        url_ = url_.replace(/[?&]$/, "");
...
export class CreateIndexDto implements ICreateIndexDto {
    ...
    static fromJS(data: any): CreateIndexDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateIndexDto();
        result.init(data);
        return result;
    }
...
export class CustomerDto implements ICustomerDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.name = _data["name"];
            this.foreignName = _data["foreignName"];
...
export class CreateCustomerDto implements ICreateCustomerDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.value = _data["value"] ? CustomerDto.fromJS(_data["value"]) : <any>undefined;
            this.action = _data["action"];
        }
    }
...
export class CreateEmployeeDto implements ICreateEmployeeDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.value = _data["value"] ? EmployeeDto.fromJS(_data["value"]) : <any>undefined;
            this.action = _data["action"];
        }
    }
