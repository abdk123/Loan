...
showCreateDialog() {
  let createCountryDialog: BsModalRef;
  createCountryDialog = this._modalService.show(
  ...
  createCountryDialog.content.onSave.subscribe(() => {
    this.refresh();
  });

}
showEditDialog(id) {
  let editCountryDialog: BsModalRef;
  editCountryDialog = this._modalService.show(
  ...
  editCountryDialog.content.onSave.subscribe(() => {
    this.refresh();
  });
}
