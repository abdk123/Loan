...
export class UserNotificationHelper extends AppComponentBase {
    ...
    getUrl(userNotification: abp.notifications.IUserNotification): string {
        switch (userNotification.notification.notificationName) {
            ...
            case 'App.NewFFWRegistered':
                return 'app/main/app/freightForwarders?id=' + userNotification.notification.data.properties.id
            case 'App.FFWRejected':
            case 'App.FFWApproved':
                return 'app/ffw/profile'
